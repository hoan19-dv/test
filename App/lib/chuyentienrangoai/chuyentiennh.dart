...
import 'package:app/chuyentienrangoai/ttgiaodich.dart';
import 'package:dropdown_button2/dropdown_button2.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter/widgets.dart';

class chuyentiennh extends StatefulWidget {
  const chuyentiennh({super.key});

  @override
  State<chuyentiennh> createState() => _chuyentiennhState();
}

class _chuyentiennhState extends State<chuyentiennh> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Chuyển tiền ra ngoài ngân hàng',
            style: TextStyle(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    SizedBox(
                      width: 90,
                      child: Text('Tài khoản ngân hàng nhận',
                          style: TextStyle(
                              fontSize: 12,
                              color: Color.fromRGBO(160, 163, 175, 1))),
                    ),
  ...
  Future<void> todopage() async {
    final route = MaterialPageRoute(builder: (context) => ttgiaodichnh());
