...
class lktaikhoannh extends StatefulWidget {
  const lktaikhoannh({super.key});

  @override
  State<lktaikhoannh> createState() => _lktaikhoannhState();
}

class _lktaikhoannhState extends State<lktaikhoannh> {
  bool checkbox = false;
